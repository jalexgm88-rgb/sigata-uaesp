...
LOGO_PATH = ASSETS_DIR / "logo_uaesp.png"
...
# --------------------------------------------------------------------------------
# Usuario institucional conectado (contexto de la sesion de gestion)
# --------------------------------------------------------------------------------
USUARIO_CONECTADO = {
    "nombre": "Jose Alexander Gomez",
    "iniciales": "JG",
    "cargo": "Supervisor del Contrato",
    "area": "Subdireccion de Aprovechamiento",
    "entidad": "Unidad Administrativa Especial de Servicios Publicos - UAESP",
}

# --------------------------------------------------------------------------------
# Proyecto de inversion asociado a la estrategia (contexto institucional)
# --------------------------------------------------------------------------------
PROYECTO_INVERSION = {
    "codigo": "8215",
    "nombre": "Fortalecimiento de la actividad de aprovechamiento en Bogota",
}

# Nombres de los meses en espanol, usados para mostrar fechas largas sin
# depender de la configuracion regional (locale) del servidor.
MESES_ES = [
...
# --------------------------------------------------------------------------------
COLOR_PRIMARY_GREEN = "#0E6E4F"      # Verde institucional (UAESP / aprovechamiento)
...
# (coordenadas de centroide aproximadas, uso ilustrativo para geolocalizacion)
# --------------------------------------------------------------------------------
LOCALIDADES_BOGOTA = {
